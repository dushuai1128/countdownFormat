 ...
 *
 * 使用方法
 * $countdownFormat = new countdownFormat($primary_seconds);
 * $ret = $countdownFormat->format();//e.g. 31天23時44分30秒
 * $format dhms 格式化格式，如果不是其中之一，则忽略
 * $unit int     countdownFormat::zh_cn | countdownFormat::zh_tw | countdownFormat::en_us 系统内置时间单位
 *       array   array( 'd' => '自定义-天', 'h' => '自定义-时', 'm' => '自定义-分', 's' => '自定义-秒' ) 自定义时间单位
 */
